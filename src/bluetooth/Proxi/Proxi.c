...
static const char local_name[] = {AD_TYPE_COMPLETE_LOCAL_NAME,'T','O','F','_','F','O','R','_','D','I','S','T','A','N','C','E'};
...
void PROXI_Init(PROXI_InitMode_t InitMode)  //PROXI_Init
{
  ...
  if(InitMode != PROXI_Limited )
  {
    ...
    BleApplicationContext.BleApplicationContext_legacy.bleSecurityParam.ioCapability = CFG_PROXI_IO_CAPABILITY;
    aci_gap_set_io_capability(BleApplicationContext.BleApplicationContext_legacy.bleSecurityParam.ioCapability);

    BleApplicationContext.BleApplicationContext_legacy.bleSecurityParam.mitm_mode = CFG_PROXI_MITM_PROTECTION;
          ...
          case EVT_LE_CONN_COMPLETE:
            {
              ...
              while((index < CFG_MAX_CONNECTION) &&
                    ((BleApplicationContext.Device_Connection_Status[index] == PROXI_IDLE) ||
                     (BleApplicationContext.Device_Connection_Status[index] == PROXI_CONNECTED_SERVER) ||
                     (BleApplicationContext.Device_Connection_Status[index] == PROXI_CONNECTED_CLIENT)))
              {
                index++;
              }
              ...
              if(index < CFG_MAX_CONNECTION)
              {
                if(BleApplicationContext.Device_Connection_Status[index] == PROXI_LP_CONNECTING)
